...
# 27410 - Group assignment - Group [2] - [TITLE]

> Dear students, thank you for accepting the group assignment. Please fill in the
> requested information below and above ([2] and [TITLE]) and remove this quoted part before submission (everything prepended with a >).
